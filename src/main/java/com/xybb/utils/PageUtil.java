...
public class PageUtil {
     ...
     * @return
     */
    public static PageUtil getPageUtils(int bodySize, int pageShowSize, String pageMethodName, int thisPage) {

        PageUtil pageTool = new PageUtil();
        ...
        pageTool.pageToolStr = setPageUtilsStr(thisPage, pageTool.pageSize, pageTool.pageMethodName);
