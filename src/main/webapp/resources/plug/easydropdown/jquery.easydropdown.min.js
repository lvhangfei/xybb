...
(function (d) {
    ...
    e.prototype = {constructor: e, instances: [], init: function (a, c) {
        ...
        a.$select.on({"focus.easyDropDown": function () {
            ...
            if (a.inFocus) {
                ...
                if (a.down)if (9 == b || 27 == b)a.close(); else {
                    ...
                    if (8 == b)return c.preventDefault(), a.query = a.query.slice(0, -1), a.search(), clearTimeout(a.resetQuery),
                        !1;
        ...
        var a =
            Object.getPrototypeOf(this).instances, c;
        ...
        this.$select.find("option").removeAttr("selected").eq(b).attr("selected", "selected").parent().trigger("change");
